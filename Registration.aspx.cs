    ...
    {   
        ...
        protected void createAccount()
        {
            ...
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("INSERT INTO Account VALUES(@Email, @Fname,@Lname,@Credit,@PasswordHash,@PasswordSalt,@DateTimeRegistered,@IV,@Key,@Lock,@Birthdate)"))
                    {
