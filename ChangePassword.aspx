<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="AppSecProject.ChangePassword" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <tr>
                <td class="style3">
        <asp:Label ID="Label2" runat="server" Text="Please Enter New Password"></asp:Label>
                </td>
                <td class="style2">
